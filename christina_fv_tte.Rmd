...
*note: restricted to complete data (no missing for time to eat or other intake variables - happy to revisit imputation)
\
\FloatBarrier
...
\
Overall Model: mean consumed = 50.85 g, Each 10 more minutes spent eating (i.e., time to eat) is associated with a 13% increase in grams of F/V consumed relative to mean (for those that chose F/V) - over 1 week this equates to 33 g increase of F/V consumed
\

Elementary: mean consumed = 47.07 g, Each 10 more minutes spent eating (i.e., time to eat) is associated with a 16% increase in grams of F/V consumed relative to mean (for those that chose F/V) - over 1 week this equates to 37.5 g increase of F/V consumed
\

High Schools: mean consumed = 47.40 g, Each 10 more minutes spent eating (i.e., time to eat) is associated with a 8% increase in grams of F/V consumed relative to mean (for those that chose F/V) - over 1 week this equates to 19 g increase of F/V consumed
\

Middle Schools - Time to Eat is non-significant for grams of F/V consumed (for those that selected some F/V)
